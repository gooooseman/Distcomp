...
public class MessageRepository : IMessageRepository
{
    ...
    {
        return await _mapper.FirstOrDefaultAsync<Message>(
            "WHERE id = ?", id);
    }
    ...
    {
        return await _mapper.FetchAsync<Message>(
            "WHERE topic_id = ? ALLOW FILTERING", topicId);
    }
}