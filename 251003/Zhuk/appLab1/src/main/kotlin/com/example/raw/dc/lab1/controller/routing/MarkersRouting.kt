...
import com.example.raw.dc.lab1.dto.request.MarkerRequestTo
import com.example.raw.dc.lab1.dto.request.MarkerRequestToId
...
fun Route.stickersRouting() {
	val stickersService by inject<MarkerService>()
...
private fun Route.checkStickers(stickersService: MarkerService) {
	get {
...
private fun Route.createSticker(stickersService: MarkerService) {
	post {
...
private fun Route.getSticker(stickersService: MarkerService) {
	get("/{id?}") {
...
private fun Route.deleteSticker(stickersService: MarkerService) {
	delete("/{id?}") {
...
private fun Route.updateSticker(stickersService: MarkerService) {
	put {
