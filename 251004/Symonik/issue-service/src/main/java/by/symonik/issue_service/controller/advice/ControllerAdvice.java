package by.symonik.issue_service.controller.advice;
...
public class ControllerAdvice {
    ...
    public ResponseEntity<ExceptionObject> response404(@RequestBody Exception exception) {
        log.error("CreatorControllerAdvice.response404: EditorNotFoundException caught.", exception);
    ...
    @ExceptionHandler(value = {
            EditorLoginDuplicationException.class,
            IssueTitleDuplicationException.class
    })
    public ResponseEntity<ExceptionObject> response403(@RequestBody Exception exception) {
        log.error("CreatorControllerAdvice.response404: EditorLoginDuplicationException caught.", exception);
