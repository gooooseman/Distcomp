...
public class NotesController : ControllerBase
{
    ...
    public NotesController(IDiscussionClient messageClient)
    {
    ...
    [HttpPost]
    public async Task<IActionResult> CreateMessage([FromBody] LabelRequestDTO message)
    {
    ...
    [HttpPut]
    public async Task<IActionResult> UpdateMessage([FromBody] LabelRequestDTO message)
    {
